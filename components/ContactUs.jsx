  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center mb-4">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="phone" className="text-white mr-4">
                Email
              </label>
              <input
                type="radio"
        ...
        <div className="flex flex-col items-center  px-10 justify-center mb-8">
          ...
          <select
            className="py-3 px-6 bg-transparent text-white border border-blue-500 rounded-full focus:outline-none focus:border-blue-700"
            value={selectedForm}
        ...
        {selectedForm === "services" && <Services updateFormData={updateFormData}/>}
        {selectedForm === "ingenious-ams" && <IngeniousAMS updateFormData={updateFormData}/>}
        {selectedForm === "ingenious-payment" && <IngeniousPayment updateFormData={updateFormData}/>}
        {selectedForm === "eduCollabo-africa" && <EduCollaboAfrica updateFormData={updateFormData}/>}
        {selectedForm === "med-tech" && <Medtech updateFormData={updateFormData}/>}
        {selectedForm === "agriwave" && <Agriwave updateFormData={updateFormData} />}
        {selectedForm === "studio" && <StudioEte updateFormData={updateFormData} />}
